...
var board = new firmata.Board("/dev/ttyACM0",function(){
    ...
    board.pinMode(1, board.MODES.ANALOG); // analog pin for SHARP sensor 0A41SK F 3Z
...
// Senzorji imajo prioriteto / sensor    
    ...
    board.analogRead(0, function(value) {
        ...
        arraySensor1.splice(0,1); // na mestu 0 v polju odrežemo eno vrednost
        arraySensor1[9] = value; // na koncu jo dodamo
        
        sum = arraySensor1.reduce(function(a, b) { return a + b; }); // vsota polja
	...
	//}
        ...
        if (averageSensor > 75 && emergency1 == 0) { 
            
            STARTctrlFW = 0; // zastavica za zagon kontrolnega algoritma za Naprej
            STARTctrlBK = 1; // zastavica za zagon kontrolnega algoritma za Nazaj
   ...
   board.analogRead(1, function(value) {
        ...
        arraySensor2.splice(0,1); // na mestu 0 v polju odrežemo eno vrednost
        arraySensor2[9] = value; // na koncu jo dodamo
        
        sum = arraySensor2.reduce(function(a, b) { return a + b; }); // vsota polja
        averageSensor = sum / 10; // povprečje polja
	...
	//}
        ...
        if (averageSensor > 75 && emergency2 == 0) { 
