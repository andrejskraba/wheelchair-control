...
function handler (req, res) { // handler za "response"; ta handler "handla" le datoteko index.html
    ...
    fs.readFile(__dirname + "/pwmbutton_40.html",
    ...
    case('/admin') : // v primeru, da je v web naslovu na koncu napisano /zahvala
               
    fs.readFile(__dirname + "/pwmbutton_admin_40.html",
    function (err, data) { // callback funkcija za branje tekstne datoteke
        if (err) {
            res.writeHead(500);
